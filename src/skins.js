...
export const SKINS = [
  {
    ...
    tier: 'common',
    price: 0,
    description: 'A fresh arena recruit — no frills, all grit.',
    tint: null,
    assetsReady: true,
  },
  {
    ...
    tier: 'common',
    price: 600,
    description: 'A shadow-warrior who strikes silent and vanishes.',
    tint: 0x5a6172,
    assetsReady: true,
  },
  {
    ...
    tier: 'common',
    price: 900,
    description: 'A sharpshooter-warrior of the wild green frontier.',
    tint: 0x66bb6a,
    assetsReady: true,
  },
  {
    ...
    tier: 'uncommon',
    price: 1500,
    description: 'A brawler-warrior with a soft look and a heavy paw.',
    tint: 0xd6d6d6,
    assetsReady: true,
  },
  {
    ...
    tier: 'rare',
    price: 2500,
    description: 'A war-machine warrior forged of chrome and circuits.',
    tint: 0x90caf9,
    assetsReady: true,
  },
  {
    ...
    tier: 'rare',
    price: 4000,
    description: "An armored warrior sworn to the arena's old code.",
    tint: 0xb0bec5,
    assetsReady: true,
  },
  {
    ...
    tier: 'epic',
    price: 6000,
    description: 'A buccaneer-warrior who plunders every wave.',
    tint: 0xe57373,
    assetsReady: true,
  },
  {
    ...
    tier: 'legendary',
    price: 9000,
    description: 'A cosmic warrior who fights where no one can hear it.',
    tint: 0xeceff1,
    assetsReady: true,
  },
];
