export const ENEMY_SPRITES = {
  monster: {
    ...
    path: '/assets/enemies/monster/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  firecaster: {
    key: 'enemy-firecaster-walk',
    path: '/assets/enemies/firecaster/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  tank: {
    key: 'enemy-tank-walk',
    path: '/assets/enemies/tank/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  splitter: {
    key: 'enemy-splitter-walk',
    path: '/assets/enemies/splitter/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  bomber: {
    key: 'enemy-bomber-walk',
    path: '/assets/enemies/bomber/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  healer: {
    key: 'enemy-healer-walk',
    path: '/assets/enemies/healer/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  summoner: {
    key: 'enemy-summoner-walk',
    path: '/assets/enemies/summoner/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  shielded: {
    key: 'enemy-shielded-walk',
    path: '/assets/enemies/shielded/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  teleporter: {
    key: 'enemy-teleporter-walk',
    path: '/assets/enemies/teleporter/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  sniper: {
    key: 'enemy-sniper-walk',
    path: '/assets/enemies/sniper/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  egg: {
    key: 'enemy-egg-walk',
    path: '/assets/enemies/egg/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
  slime: {
    key: 'enemy-slime-walk',
    path: '/assets/enemies/slime/walk.png',
    frameWidth: 64,
    frameHeight: 64,
  },
};
